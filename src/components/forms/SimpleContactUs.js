...
const SubmitButton = tw.button`w-full sm:w-32 mt-6 py-3 text-primary-500 rounded-full font-bold tracking-wide shadow-lg uppercase text-sm transition duration-300 transform bg-gray-300 hover:text-primary-700 hocus:-translate-y-px hocus:shadow-xl`;
